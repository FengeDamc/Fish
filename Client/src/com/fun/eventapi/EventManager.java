...
import com.fun.eventapi.event.EventStoppable;
import com.fun.eventapi.types.Priority;
...
public final class EventManager {
     ...
     * a new MethodData to key's matching list and sorts it based on Priority. @see com.fun.eventapi.types.Priority
     ...
     */
    public static final com.fun.eventapi.event.events.Event call(final com.fun.eventapi.event.events.Event event) {
