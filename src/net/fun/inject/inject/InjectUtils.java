...
import net.fun.inject.InjectorUtils;
import net.fun.inject.NativeUtils;
...
public class InjectUtils {
    ...
    public static void destroyClient() {
        ...
        try {
            Agent.findClass("net.fun.client.FunGhostClient").getDeclaredMethod("destroyClient").invoke(null);
