...
import net.fun.client.config.ConfigModule;
import net.fun.gui.FishFrame;
import net.fun.inject.inject.*;
import net.fun.inject.inject.asm.api.Inject;
import net.fun.inject.inject.asm.api.Mixin;
import net.fun.inject.inject.asm.api.Transformer;
import net.fun.inject.inject.asm.api.Transformers;
...
import net.fun.utils.font.FontManager;
...
import static net.fun.inject.inject.asm.api.Transformers.*;
...
public class Agent {
    ...
    /*public static void agentmain(String args, Instrumentation is) throws URISyntaxException, IOException {
        ...
        try {
            Class<?> agentClass = Agent.findClass("net.fun.inject.Agent");
    ...
    public static synchronized void start() throws URISyntaxException, IOException, InterruptedException {
                ...
                try {
                    ...
                    Class<?> agentClass = Agent.findClass("net.fun.inject.Agent");
                    //NativeUtils.messageBox("GOTAGENT","Fish");
                    //agentClass = Agent.findClass("net.fun.inject.Agent");
                ...
                for (Transformer transformer : transformers) {
                    try {
                       // NativeUtils.messageBox("Retrans:"+transformer.clazz.getName(),"Fish");
